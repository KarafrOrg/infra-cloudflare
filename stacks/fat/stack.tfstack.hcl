# FAT Environment Stack
# This stack orchestrates all Cloudflare components for the FAT (Feature Acceptance Testing) environment
...
# DNS Component - Creates and manages Cloudflare zone and DNS records
component "dns" {
...
# WAF Component - Manages WAF rules, rate limiting, and firewall rules
component "waf" {
